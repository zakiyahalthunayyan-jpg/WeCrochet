...
<a href="/WECROCHET/home.php" class="logo">🧶 WeCrochet</a>

    <form method="GET" action="/WECROCHET/index.php" class="search-form">
        <input type="text" name="search" placeholder="Search products..." class="search-input">
        <button type="submit" class="search-btn">🔍</button>
    </form>

    <ul class="nav-links">
<li><a href="/WECROCHET/home.php">Home</a></li>
        <li><a href="/WECROCHET/index.php">Products</a></li>
        <li><a href="/WECROCHET/pages/contact.php">Contact Us</a></li>
    </ul>
