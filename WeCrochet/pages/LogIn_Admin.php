...
<div class="container">
  ...
  <div class="right-panel">
    ...
    <form action="" method="POST">
      <input type="text" name="admin_user" placeholder="Username" class="input-box" required>
      <input type="password" name="admin_pass" placeholder="Password" class="input-box" required>
